import 'package:awdotcom/FirebaseAuthService/firebase_auth_services.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:awdotcom/Authtentication/login.dart';
//import 'package:awdotcom/JsonModels/users.dart';
...
class _SignUpState extends State<SignUp> {
  ...
  void _signUp() async{
    ...
    //TextEditingController usrName= username;
    //TextEditingController passwrd= password;
    //TextEditingController usrName= username;
    User? user=await _auth.signUpWithEmailAndPassword(usrname,passwrd);
    if(user!=null){
